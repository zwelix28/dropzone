...
const TYPE_PRESETS = {
  ...
  mix_submitted: { icon: "send", color: "var(--orange)", category: "Review" },
  mix_approved: { icon: "check", color: "var(--green)", category: "Submission" },
  mix_rejected: { icon: "x", color: "var(--red)", category: "Submission" },
